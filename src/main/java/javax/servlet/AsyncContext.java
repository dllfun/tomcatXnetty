...
public interface AsyncContext {
	...
	/**
	 * @throws IllegalStateException if this method is called when the request is
	 *                               not in asynchronous mode. The request is in
	 ...
	 *                               has been called and before {@link #complete()}
