...
public interface AccessLog {
	...
	/**
	 * Name of request attribute used to override the remote address recorded by the
	 * AccessLog.
	 */
	public static final String REMOTE_ADDR_ATTRIBUTE = "org.apache.catalina.AccessLog.RemoteAddr";

	/**
	 * Name of request attribute used to override remote host name recorded by the
	 * AccessLog.
	 */
	...
	/**
	 * Name of request attribute used to override the server name recorded by the
	 * AccessLog.
	 */
	public static final String SERVER_NAME_ATTRIBUTE = "org.apache.catalina.AccessLog.ServerName";

	/**
	 * Name of request attribute used to override the server port recorded by the
	 * AccessLog.
	 */
	 ...
	 *                                 used, <code>false</code> causes the original
	 *                                 values to be used.
	 */
