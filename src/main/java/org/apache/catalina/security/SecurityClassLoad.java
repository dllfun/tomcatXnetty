...
public final class SecurityClassLoad {
	...
	private static final void loadTomcatPackage(ClassLoader loader) throws Exception {
		...
		loader.loadClass(basePackage + "util.net.Channel$BlockingMode");
		loader.loadClass(basePackage + "util.net.Channel$CompletionCheck");
		loader.loadClass(basePackage + "util.net.Channel$CompletionHandlerCall");
		loader.loadClass(basePackage + "util.net.Channel$CompletionState");
