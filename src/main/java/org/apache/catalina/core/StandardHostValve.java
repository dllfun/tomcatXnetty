...
final class StandardHostValve extends ValveBase {
	...
	/**
	 * Select the appropriate child Context to process this request, based on the
	 * specified request URI. If no matching Context can be found, return an
	 ...
	 * exceptions that occur during generation of the error report are logged and
	 * swallowed.
	 *
	...
	private void status(Request request, Response response) {
		...
		/*
		 * Only look for error pages when isError() is set. isError() is set when
		 * response.sendError() is invoked. This allows custom error pages without
		 * relying on default from web.xml.
		 */
		if (!response.isError()) {
			return;
		}
	 ...
	 * Request to produce the specified Response. Any exceptions that occur during
	 * generation of the exception report are logged and swallowed.
	 *
	 * @param request   The request being processed
	 * @param response  The response being generated
	 * @param throwable The exception that occurred (which possibly wraps a root
	 *                  cause exception
	 */
	 ...
	 * location included in the specified errorPage object. It is assumed that the
	 * caller has already recorded any request attributes that are to be forwarded
	 * to this page. Return <code>true</code> if we successfully utilized the
	 * specified error page location, or <code>false</code> if the default error
