...
public class NamingContextListener implements LifecycleListener, ContainerListener, PropertyChangeListener {
	 ...
	 *
	 * @deprecated The {@link ContainerListener} interface and implementing methods
	 *             will be removed from this class for Tomcat 10 onwards.
	 */
	@Deprecated
	@Override
	...
	public void addResource(ContextResource resource) {
		...
		if (("javax.sql.DataSource".equals(ref.getClassName()) || "javax.sql.XADataSource".equals(ref.getClassName()))
	 ...
	 *
	 * @param name the name of the resource environment reference which should be
	 *             removed
	 */
