...
final class ApplicationDispatcher implements AsyncDispatcher, RequestDispatcher {
	 ...
	 * variables causes threading issues and state is too complex to pass and return
	 * single ServletRequest or ServletResponse objects.
	 */
	...
	/**
	 * Construct a new instance of this class, configured according to the specified
	 * parameters. If both servletPath and pathInfo are <code>null</code>, it will
	 * be assumed that this RequestDispatcher was acquired by name, rather than by
	 * path.
	 *
	 * @param wrapper     The Wrapper associated with the resource that will be
	 ...
	 * @param pathInfo    The revised extra path information to this resource (if
	 *                    any)
	 * @param queryString Query string parameters included with this request (if
	 *                    any)
	 * @param mapping     The mapping for this resource (if any)
	 * @param name        Servlet name (if a named dispatcher was created) else
	 *                    <code>null</code>
	 */
	...
	/**
	 * Combine the servletPath and the pathInfo. If pathInfo is <code>null</code> it
	 * is ignored. If servletPath is <code>null</code> then <code>null</code> is
	 * returned.
	 * 
	...
	/**
	 * Create and return a request wrapper that has been inserted in the appropriate
	 * spot in the request chain.
	 */
