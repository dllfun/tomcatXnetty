...
public class StandardContext extends ContainerBase implements Context, NotificationEmitter {
	 ...
	 * our ClassLoader. Graal cannot actually load a class from the webapp
	 * classloader, so delegate by default.
	 */
	...
	/**
	 * Should Tomcat skip the memory leak checks when the web application is stopped
	 * as part of the process of shutting down the JVM?
	 */
	 ...
	 *             {@link #getNamingResources()} instead
	 */
	@Deprecated
	...
	/**
	 * Add a new servlet mapping, replacing any existing mapping for the specified
	 * pattern.
	 *
