...
public class ApplicationContext implements ServletContext {
	...
	/**
	 * Construct a new instance of this class, associated with the specified Context
	 * instance.
	 *
	...
	/**
	 * Flag that indicates if a new {@link ServletContextListener} may be added to
	 * the application. Once the first {@link ServletContextListener} is called, no
	 * more may be added.
	 */
	...
	/**
	 * Return the MIME type of the specified file, or <code>null</code> if the MIME
	...
	/**
	 * Return a <code>RequestDispatcher</code> object that acts as a wrapper for the
	 * named servlet.
	 *
	...
	/*
	 * Returns null if the input path is not valid or a path that will be acceptable
	 * to resources.getResource().
	 */
	...
	public void setSessionTrackingModes(Set<SessionTrackingMode> sessionTrackingModes) {
		...
		if (!context.getState().equals(LifecycleState.STARTING_PREP)) {
			throw new IllegalStateException(
					sm.getString("applicationContext.setSessionTracking.ise", getContextPath()));
		}
	...
	public void setRequestCharacterEncoding(String encoding) {
		if (!context.getState().equals(LifecycleState.STARTING_PREP)) {
			throw new IllegalStateException(
					sm.getString("applicationContext.setRequestEncoding.ise", getContextPath()));
		}
	...
	public void setResponseCharacterEncoding(String encoding) {
		if (!context.getState().equals(LifecycleState.STARTING_PREP)) {
			throw new IllegalStateException(
					sm.getString("applicationContext.setResponseEncoding.ise", getContextPath()));
		}
