...
final class StandardWrapperValve extends ValveBase {
	...
	/**
	 * Invoke the servlet we are managing, respecting the rules regarding servlet
	 * lifecycle and SingleThreadModel support.
	 *
	 ...
	 * @param exception The exception that occurred (which possibly wraps a root
	 *                  cause exception
	 */
