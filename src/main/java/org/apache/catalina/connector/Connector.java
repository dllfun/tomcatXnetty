...
public class Connector extends LifecycleMBeanBase {
	...
	/**
	 * Coyote Protocol handler class name. See {@link #Connector()} for current
	 * default.
	 */
	...
	/**
	 * The server port to which we should pretend requests to this Connector were
	 * directed. This is useful when operating Tomcat behind a proxy server, so that
	...
	/**
	 * The flag that controls recycling of the facades of the request processing
	 * objects. If set to <code>true</code> the object facades will be discarded
	 * when the request is recycled. If the security manager is enabled, this
	...
	/**
	 * The maximum number of cookies permitted for a request. Use a value less than
	 * zero for no limit. Defaults to 200.
	 */
	private int maxCookieCount = 200;

	/**
	 * The maximum number of parameters (GET plus POST) which will be automatically
	 * parsed by the container. 10000 by default. A value of less than 0 means no
	 * limit.
	 */
	 ...
	 * @return the property value
	 *
	 * @deprecated Use {@link #getProperty(String)}. This will be removed in Tomcat
	 *             10 onwards.
	 */
	@Deprecated
	 ...
	 * @param value the property value
	 *
	 * @deprecated Use {@link #setProperty(String, String)}. This will be removed in
	 *             Tomcat 10 onwards.
	 */
	@Deprecated
	...
	/**
	 * @return <code>true</code> if the TRACE method is allowed. Default value is
	 *         <code>false</code>.
	 */
	...
	/**
	 * @return <code>true</code> if the object facades are discarded, either when
	 *         the discardFacades value is <code>true</code> or when the security
	 *         manager is enabled.
	 */
	 ...
	 * automatically parsed by the container. A value of less than 0 means no limit.
	 *
	...
	/**
	 * @return the maximum size of a POST which will be automatically parsed by the
	 *         container.
	 */
	...
	/**
	 * Set the maximum size of a POST which will be saved by the container during
	 * authentication.
	 *
	 * @param maxSavePostSize The new maximum size in bytes of a POST which will be
	 *                        saved by the container during authentication.
	 */
	...
	/**
	 * Set list of HTTP methods which should allow body parameter parsing. This
	...
	/**
	 * @return the port number on which this connector is configured to listen for
	 *         requests. The special value of 0 means select a random free port when
	 *         the socket is bound.
	 */
	public int getPort() {
	...
	/**
	 * @return the port number on which this connector is listening to requests. If
	 *         the special value for {@link #getPort} of zero is used then this
	 *         method will report the actual port bound.
	 */
	...
	public String getProtocol() {
		...
		if ((!apr && org.apache.coyote.http11.Http11NioProtocol.class.getName().equals(protocolHandlerClassName))
				|| (apr && org.apache.coyote.http11.Http11AprProtocol.class.getName()
						.equals(protocolHandlerClassName))) {
			return "HTTP/1.1";
	...
	/**
	 * @return the port number to which a request should be redirected if it comes
	 *         in on a non-SSL port and is subject to a security constraint with a
	...
	/**
	 *
	 * @return The Charset to use to convert raw URI bytes (after %nn decoding) to
	 *         characters. This will never be null
	 */
	 ...
	 *
	 * @return <code>true</code> if generation of X-Powered-By response header is
	 ...
	 * Servlet/2.5) for all servlet-generated responses returned by this Connector.
	 *
	 * @param xpoweredBy true if generation of X-Powered-By response header is to be
	 *                   enabled, false otherwise
	 */
	...
	protected void initInternal() throws LifecycleException {
		...
		if (AprLifecycleListener.isAprAvailable() && AprLifecycleListener.getUseOpenSSL()
			...
			if (jsseProtocolHandler.isSSLEnabled() && jsseProtocolHandler.getSslImplementationName() == null) {
				// OpenSSL is compatible with the JSSE configuration, so use it if APR is
				// available
