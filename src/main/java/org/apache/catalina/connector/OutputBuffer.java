...
public class OutputBuffer extends Writer {
	...
	public void close() throws IOException {
		...
		// If there are chars, flush all of them to the byte buffer now as bytes are
		// used to
	 ...
	 * Flush bytes or chars contained in the buffer.
	 *
	 * @param realFlush <code>true</code> if this should also cause a real network
	 *                  flush
	 * @throws IOException An underlying IOException occurred
	 */
	...
	/**
	 * Sends the buffer data to the client output, checking the state of Response
	 * and calling the right interceptors.
	 *
	...
	/*
	 * All the non-blocking write state information is held in the Response so it is
	 * visible / accessible to all the code that needs it.
	 */
