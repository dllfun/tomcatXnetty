...
public class JMXProxyServlet extends HttpServlet {
	 ...
	 *
	 * @param paramString The string containing comma-separated operation-invocation
	 *                    parameters, or <code>null</code> if there are no
	 *                    parameters.
	 ...
	 *                   to call the requested operation.
	...
	private Object invokeOperationInternal(String onameStr, String operation, String[] parameters)
		...
		if (null == methodInfo) {
			// getMethodInfo returns null for both "object not found" and "operation not
			// found"
			MBeanInfo info = null;
			try {
