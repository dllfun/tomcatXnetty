...
public class CompressionConfig {
	...
	/**
	 * Obtain the String form of the regular expression that defines the user agents
	 * to not use gzip with.
	 *
	...
	/**
	 * Determines if compression should be enabled for the given response and if it
	 * is, sets any necessary headers to mark it as such.
	 *
