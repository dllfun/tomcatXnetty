...
public class RequestInfo {
	...
	/**
	 * Obtain the remote address for this connection as reported by an intermediate
	 * proxy (if any).
	 *
	...
	/**
	 * Called by the processor before recycling the request. It'll collect statistic
	 * information.
	 */
	void updateCounters() {
