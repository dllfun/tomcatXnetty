...
public class Nio2Handler implements Handler<Nio2Channel> {
	...
	public Nio2Handler(Handler next, AbstractProtocol<Nio2Channel> protocol) {
		this.next = next;
	...
	@Override
	public void processSocket(Channel<Nio2Channel> channel, SocketEvent event, boolean dispatch) {
