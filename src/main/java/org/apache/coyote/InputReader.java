...
public interface InputReader {
	 ...
	 * ApplicationBufferHandler. IMPORTANT: the current model assumes that the
	 * protocol will 'own' the ByteBuffer and return a pointer to it.
	 *
	 * @param handler ApplicationBufferHandler that provides the buffer to read data
	 *                into.
	 *
	 * @return The number of bytes that have been added to the buffer or -1 for end
	 *         of stream
	 *
