 ...
 *
 * This is the main interface to be implemented by a coyote protocol. Adapter is
 * the main interface to be implemented by a coyote servlet container.
 *
...
public interface ProtocolHandler {
	 ...
	 * was bound on {@link #start()} (rather than on {@link #init()} but do not
	 ...
	 *
	 * @return <code>true</code> if this Protocol Handler requires the APR/native
	 *         library, otherwise <code>false</code>
	 */
	...
	/**
	 * Find all configured SSL virtual host configurations which will be used by
	 * SNI.
	 * 
	...
	/**
	 * Some protocols, like AJP, have a packet length that shouldn't be exceeded,
	 * and this can be used to adjust the buffering used by the application layer.
	 * 
