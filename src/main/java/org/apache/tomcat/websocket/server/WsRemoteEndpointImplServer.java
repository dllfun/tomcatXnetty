...
public class WsRemoteEndpointImplServer extends WsRemoteEndpointImplBase {
	 ...
	 * call clearHandler() with useDispatch == false but the method parameter was
	 * added in case other callers started to use this method to make sure that
	 * those callers think through what the correct value of useDispatch is for
	 * them.
	 */
	 ...
	 * @param useDispatch Should {@link SendHandler#onResult(SendResult)} be called
	 *                    from a new thread, keeping in mind the requirements of
