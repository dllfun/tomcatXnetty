...
public class WsServerContainer extends WsWebSocketContainer implements ServerContainer {
	...
	/**
	 * Published the provided endpoint implementation at the specified path with the
	 * specified configuration. {@link #WsServerContainer(ServletContext)} must be
	 ...
	 * <p>
	 * Note: This method is not used by Tomcat but is used directly by third-party
	 * code and must not be removed.
	 *
	 * @param request    The request object to be upgraded
	 * @param response   The response object to be populated with the result of the
	 *                   upgrade
	 ...
	 *
	 * @throws ServletException If a configuration error prevents the upgrade from
	 *                          taking place
