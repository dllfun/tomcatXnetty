...
public class Diagnostics {
	...
	public static void setThreadContentionMonitoringEnabled(boolean enable) {
		...
		if (enable != checkValue) {
			log.error("Could not set threadContentionMonitoringEnabled to " + enable + ", got " + checkValue
					+ " instead");
		}
	}
	...
	public static void setLoggerLevel(String loggerName, String levelName) {
		...
		if (!checkValue.equals(levelName)) {
			log.error("Could not set logger level for logger '" + loggerName + "' to '" + levelName + "', got '"
					+ checkValue + "' instead");
		}
	}
	...
	public static void setVerboseGarbageCollection(boolean verbose) {
		...
		if (verbose != checkValue) {
			log.error("Could not set verbose garbage collection logging to " + verbose + ", got " + checkValue
					+ " instead");
		}
	}
	...
	/**
	 * Check if any threads are deadlocked. If any, print the thread dump for those
	 * threads.
	 *
	 * @return a deadlock message and the formatted thread dump of the deadlocked
	 *         threads
	 */
	...
	/**
	 * Retrieves a formatted JVM thread dump. The default StringManager will be
	 * used.
	 *
	...
	/**
	 * Retrieves a formatted JVM thread dump. The given list of locales will be used
	...
	/**
	 * Retrieves a formatted JVM information text. The default StringManager will be
	 * used.
	 *
	...
	/**
	 * Retrieves a formatted JVM information text. The given list of locales will be
	 * used to retrieve a StringManager.
	 *
	 * @param requestedLocales list of locales to use
	 * @return the formatted JVM information text
	 */
