...
public final class MessageBytes implements Cloneable, Serializable {
	...
	/**
	 * getType() is T_STR if the the object used to create the MessageBytes was a
	 * String
	 */
	public static final int T_STR = 1;
	/**
	 * getType() is T_BYTES if the the object used to create the MessageBytes was a
	 * byte[]
	 */
	public static final int T_BYTES = 2;
	/**
	 * getType() is T_CHARS if the the object used to create the MessageBytes was a
	 * char[]
	 */
	...
	/**
	 * Creates a new, uninitialized MessageBytes object. Use static newInstance() in
	 * order to allow future hooks.
	 */
	...
	/**
	 * Returns the byte chunk, representing the byte[] and offset/length. Valid only
	 * if T_BYTES or after a conversion was made.
	 * 
	...
	/**
	 * Returns the char chunk, representing the char[] and offset/length. Valid only
	 * if T_CHARS or after a conversion was made.
	 * 
	...
	/**
	 * Returns the length of the original buffer. Note that the length in bytes may
	 * be different from the length in chars.
	 * 
	 * @return the length
	 */
