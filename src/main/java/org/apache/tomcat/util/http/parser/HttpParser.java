...
public class HttpParser {
	 ...
	 * Since a token requires at least 1 tchar, {@code null} and the empty string
	 * ({@code ""}) are not considered to be valid tokens.
	 *
	 ...
	 *         to read or <code>null</code> if data other than a token was found
	 */
	...
	/**
	 * @return the digits if any were found, the empty string if no data was found
	...
	/**
	 * @return the number if digits were found, -1 if no data was found or if data
	 *         other than digits was found
	 */
	 ...
	 *         or <code>null</code> if data other LHEX was found
	 */
