...
public class MimeHeaders {
	/**
	 * Initial size - should be == average number of headers per request XXX make it
	 * configurable ( fine-tuning of web-apps )
	 */
	 ...
	 * @return the Nth header name, or null if there is no such header. This may be
	 *         used to iterate through all header fields.
	 */
	...
	/**
	 * @param n The header index
	 * @return the Nth header value, or null if there is no such header. This may be
	 *         used to iterate through all header fields.
	 */
	...
	/**
	 * Returns an enumeration of strings representing the header field names. Field
	 * names may appear multiple times in this enumeration, indicating that multiple
	 * fields with that name exist in this header.
	 * 
	...
	/**
	 * Adds a partially constructed field to the header. This field has not had its
	 * name or value initialized.
	 */
	...
	/**
	 * Create a new named header using un-translated byte[]. The conversion to chars
	 * can be delayed until encoding is known.
	 * 
	 ...
	 * exists, null is returned. If more than one such field is in the header, an
	...
	/**
	 * Finds and returns a unique header field with the given name. If no such field
	 * exists, null is returned. If the specified header field is not unique then an
	...
	// -------------------- Removing --------------------
	/**
	 * Removes a header field with the specified name. Does nothing if such a field
	 * could not be found.
	 * 
