...
public class Acceptor<U> implements Runnable {
	...
	private final SocketWrapperBaseEndpoint<?, U> endpoint;
	private String threadName;
	protected volatile AcceptorState state = AcceptorState.NEW;

	public Acceptor(SocketWrapperBaseEndpoint<?, U> endpoint) {
	 ...
	 * amounts of logging. For example, this can happen if the ulimit for open files
	 * is reached.
	 *
