...
public enum SocketEvent {
	...
	/**
	 * The associated Connector/Endpoint is stopping and the connection/socket needs
	 ...
	 * return to the container for any necessary clean-up. Examples of where this is
	 * used include:
	 * <ul>
	 * <li>by NIO2 to signal the failure of a completion handler</li>
	 * <li>by the container to signal an I/O error on a non-container thread during
	 * Servlet 3.0 asynchronous processing.</li>
	 * </ul>
	 */
	ERROR,

	/**
	 * A client attempted to establish a connection but failed. Examples of where
